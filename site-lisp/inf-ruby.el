;;; -*-Emacs-Lisp-*-
;;;
;;;  $Id: inf-ruby.el,v 1.4 2007/11/23 17:03:23 olagus Exp $
;;;  $Author: olagus $
;;;  $Date: 2007/11/23 17:03:23 $
;;;
...
;;;	
;;;	 Revision 1.2  2006/09/07 07:08:16  olagus
;;;	 Updated Ruby-modes and added jflex-mode
;;;	
...
;;;; for irb
(defvar ruby-program-name "irb --noreadline"
  "*Program invoked by the run-ruby command")

(defvar inferior-ruby-first-prompt-pattern "^j?irb(.*)[0-9:]+0> *"
  "first prompt regex pattern of ruby interpreter.")

(defvar inferior-ruby-prompt-pattern "^\\(j?irb(.*)[0-9:]+[>*\"'] *\\)+"
  "prompt regex pattern of ruby interpreter.")
