...
Validation will be enabled if `rng-nxml-auto-validate-flag' is non-nil."
  ...
  (define-key nxml-mode-map "\C-c\C-w" 'rng-what-schema)
  (define-key nxml-mode-map "\C-c\C-a" 'rng-auto-set-schema)
  (define-key nxml-mode-map "\C-c\C-s" 'rng-set-schema-and-validate)
  (define-key nxml-mode-map "\C-c\C-l" 'rng-save-schema-location)
  (define-key nxml-mode-map "\C-c\C-t" 'rng-set-document-type-and-validate)
